# Olá, eu sou [Gabriel Quaresma](https://www.linkedin.com/in/gabriel-quaresma-0b2290201/) 👋
...
* ☕ Principal stack: Java, Spring Boot e PostgreSQL
* 🐧 Familiaridade com Linux, terminal, Docker e ambientes de desenvolvimento
* 🧠 Interesse em arquitetura de software, algoritmos e modelagem de sistemas

* 🧩 Entusiasta e autodidata: sempre estudando novos conceitos, algoritmos, resolução de problemas, linguagens e boas práticas de engenharia de software
...
> Projeto Acadêmico  •  UNISUAM  •  **Empreendedorismo e Desenvolvimento Mobile**

Aplicação desenvolvida em dupla durante a graduação em Análise e Desenvolvimento de Sistemas.
...
* Integração com APIs de Google Books
...
### 🤖 [Assistente Inteligente para Eventos](https://github.com/qu4resm4/event-chatbot)
...
### 🧩 [A-Maze-ing](https://github.com/qu4resm4/a-maze-ing42)
...
* Mypy
* Flake8
* Build Tools (build, setuptools e wheel) para distribuição de bibliotecas
...
As etapas finais introduzem conceitos avançados de programação funcional e metaprogramação, incluindo closures, higher-order functions, decorators e módulos da biblioteca padrão voltados para construção de abstrações reutilizáveis.

A Piscina de Python contribuiu para fortalecer conceitos fundamentais de engenharia de software que hoje aplico independentemente da tecnologia utilizada.
